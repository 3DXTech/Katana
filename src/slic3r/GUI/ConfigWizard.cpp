...
{
    cb_3mf = new wxCheckBox(this, wxID_ANY, _L("Associate .3mf files to KatanaSlicer"));
    cb_stl = new wxCheckBox(this, wxID_ANY, _L("Associate .stl files to KatanaSlicer"));
...
{
    append_text(_L("KatanaSlicer's user interfaces comes in three variants:\nSimple, Advanced, and Expert.\n"
...
ConfigWizardIndex::ConfigWizardIndex(wxWindow *parent)
    : wxPanel(parent)
    , bg(ScalableBitmap(parent, "KatanaSlicer_192px.png", 192))
