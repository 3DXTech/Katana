...
void GLCanvas3D::LayersEditing::render_overlay(const GLCanvas3D& canvas)
{
    ...
    imgui.text_colored(ImGuiWrapper::COL_RED_LIGHT, _L("Left mouse button:"));
    ImGui::SameLine();
    imgui.text(_L("Add detail"));

    imgui.text_colored(ImGuiWrapper::COL_RED_LIGHT, _L("Right mouse button:"));
    ImGui::SameLine();
    imgui.text(_L("Remove detail"));

    imgui.text_colored(ImGuiWrapper::COL_RED_LIGHT, _L("Shift + Left mouse button:"));
    ImGui::SameLine();
    imgui.text(_L("Reset to base"));

    imgui.text_colored(ImGuiWrapper::COL_RED_LIGHT, _L("Shift + Right mouse button:"));
    ImGui::SameLine();
    imgui.text(_L("Smoothing"));

    imgui.text_colored(ImGuiWrapper::COL_RED_LIGHT, _L("Mouse wheel:"));
    ImGui::SameLine();
