...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                gcode_line_numbers))
    ((ConfigOptionEnum<GCodeFlavor>,   gcode_flavor))
    ((ConfigOptionBool,                append_cr))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloats,             extruder_heat_rate))
    ((ConfigOptionFloats,             extruder_cd_rate))
    ...
    ((ConfigOptionInt,                 annealing_time1))
    ((ConfigOptionBool,                annealing_step2_enabled))
    ((ConfigOptionInt,                 annealing_temp2))
    ((ConfigOptionInt,                 annealing_time2))
    ((ConfigOptionBool,                annealing_step3_enabled))
    ((ConfigOptionInt,                 annealing_temp3))
    ((ConfigOptionInt,                 annealing_time3))
    ((ConfigOptionBool,                annealing_step4_enabled))
    ((ConfigOptionInt,                 annealing_temp4))
    ((ConfigOptionInt,                 annealing_time4))
    ((ConfigOptionBool,                annealing_step5_enabled))
    ((ConfigOptionInt,                 annealing_temp5))
    ((ConfigOptionInt,                 annealing_time5))
    ((ConfigOptionBool,                annealing_step6_enabled))
    ((ConfigOptionInt,                 annealing_temp6))
    ((ConfigOptionInt,                 annealing_time6))
    ((ConfigOptionBool,                annealing_step7_enabled))
    ((ConfigOptionInt,                 annealing_temp7))
    ((ConfigOptionInt,                 annealing_time7))
    ((ConfigOptionBool,                annealing_step8_enabled))
    ((ConfigOptionInt,                 annealing_temp8))
    ((ConfigOptionInt,                 annealing_time8))
    ((ConfigOptionBool,                annealing_step9_enabled))
    ((ConfigOptionInt,                 annealing_temp9))
    ((ConfigOptionInt,                 annealing_time9))
    ((ConfigOptionBool,                annealing_step10_enabled))
    ((ConfigOptionInt,                 annealing_temp10))
    ((ConfigOptionInt,                 annealing_time10))
